...
//     {successMessage && <p>Blog created successfully!</p>} {/* Conditional rendering for success message */}
//     {isError && <p>Something went wrong. Please try again.</p>} {/* Conditional rendering for error message */}
...
export default function CreateBlog() {
    ...
    return (
      ...
      <ReactQuill
        ...
        modules={{
          toolbar: [
            ['bold', 'italic', 'underline', 'strike'], // Enable specific formatting options
            [{ header: 1 }, { header: 2 }],
